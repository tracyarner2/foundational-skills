...
What types of differences are there in your communications between your stakeholders? 
...
.panel[.panel-name[Citations & Bibliography]

.pull-left[
- Specify a bibliography file in your file’s header
  +ie: bibliography: rmarkdown.bib
- use @ and the citation identifier
  + Facts from articles [@smith04; @doe99]
...
.panel[.panel-name[Linear Regression]
...
```{r eval=FALSE, echo=TRUE}
# save the model
m1 <- lm(proportion_earned ~ time_spent_hours + int, 
         data = data_to_explore)
