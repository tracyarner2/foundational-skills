...
- Supervised learning
  + uses inference and Predictive modeling
    + this are similar but distinct where the researcher uses a model to interpret the relationships among features and an outcome (inference) or  whether a researcher uses a model to make predictions or classifications (prediction).
...
Again this is the general workflow. It is not a linear process and can flow to answer your research questions, or revise them depending on your needs. The next few sessions will take us through the entire workflow. Today we will focus on the *Prepare* and *Wrangle* phases.
...
.panel[.panel-name[Viz - Scatter]

.pull-left[
<img src="img/scatter.png" height="250px"/>

]
.pull-right[
<img src="img/facet_scatter.png" height="250px"/>
]
]
