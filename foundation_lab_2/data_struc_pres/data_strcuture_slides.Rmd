...
???
- applies artificial intelligence to students’ interactions with the system
- an expert, or domain model, which organizes the skills and strategies in the domain, 
- a student model of what a student understands about the domain that is inferred from their performances on learning tasks.
...
- Free/freemiam courses, certificates, PD
- Edx
- Coursera
- Friday Institute
...
Can be at the Student level or Teacher and Administrator level.
- demographics, attendance, and academic performances
- teacher- and administrator-facing repositories of student demographic and learning-outcome data.
