...
You might remember that when you start R it includes several packages like Base R package. 
We are going to reload the Tidyverse package so that we can use the readr package.
...
- show also how to click on the file and import data or compy the location
