...
Krumm sums it up nicely on page 28, "The basic idea
behind the open data movement is that anyone can access or use a dataset, and key to this movement is not just accessibility but usability. Making open data usable means making it accessible in machine-readable, structured, granular, and well-documented formats."
...
???
In this sessions. for the conceptual overview we are going to learn more about the types and characteristics of data structures common in Learning Analytics. Many of these you will be familiar with and some may be new.
...
We use Moodle at NCSU. What LMS do you use at your institution? What other types of Digital Learning environments are you using on your campus? 
...
Have you ever pulled data from your own MOOC? What types of data?
