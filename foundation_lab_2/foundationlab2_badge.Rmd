...
7. In code chunk named `filter-2`, _filter_ the sci_classes data frame so rows with NA for points earned are removed.
_Assign_ to a new object with a different name. _Use_ glimpse() to examine all columns of your data frame.
